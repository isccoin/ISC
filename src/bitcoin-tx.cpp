...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s isc-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  isc-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded isc transaction") + "\n" +
              "  isc-tx [options] -create [commands]   " + _("Create hex-encoded isc transaction") + "\n" +
              "\n";
