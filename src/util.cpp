...
const char * const BITCOIN_CONF_FILENAME = "isc.conf";
const char * const BITCOIN_PID_FILENAME = "isc.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "ISC";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/ISC";
#else
    // Unix
    return pathRet / ".isc";
#endif
