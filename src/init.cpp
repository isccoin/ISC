...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/isc-project/isc>";
    const std::string URL_WEBSITE = "<https://isc.org>";
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    g_connman->AddNode("47.74.155.120");
